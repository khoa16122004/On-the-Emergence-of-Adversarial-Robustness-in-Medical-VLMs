...
The our pretrained medical VLMs (includings vanilla, w/ SSL and w/ AT) are available at the following link: [Hugging-face](https://huggingface.co/Woffy/Medical_VLMs_SSL_CL)
